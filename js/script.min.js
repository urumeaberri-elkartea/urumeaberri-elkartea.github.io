...
$(window).on('scroll',function(){counter();});$('.cookie-btn').on('click',function(){$(".cookie-container").removeClass("active");localStorage.setItem("cookieBannerDisplayed","true");});});